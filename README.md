...
Универсальный интерфейс документооборота на React, TypeScript и Vite. Формы, колонки, статусы и вложения настраиваются через каталог Corelia. Имя npm-пакета и рабочего каталога — corelia-web.
